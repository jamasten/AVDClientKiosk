...
Write-Output "*********************************"
Write-Output "Removing Built-In Windows 10 Apps"
Write-Output "*********************************"
$apps = "Microsoft.3DBuilder", "Microsoft.BingWeather", "# Microsoft.DesktopAppInstaller",`
    ...
    "Microsoft.OneConnect", "Microsoft.Outlook.DesktopIntegrationServices", "Microsoft.People", "Microsoft.Print3D", "Microsoft.ScreenSketch", `
